...
export default function TopBar({ activePage, onNavigate, onLogout, notifs, onMarkAllRead, onMarkRead }: TopBarProps) {
  ...
  // Shared surface tokens that adapt to dark mode
    ...
    <header style={{
      ...
      <div style={{ flex: 1 }}>
        <h1 style={{
          ...
          {pageTitles[activePage] ?? 'SciCollab'}
        </h1>
      </div>
      ...
      <div style={{ position: 'relative' }} ref={notifRef}>
        ...
        {notifOpen && (
          <div style={{ ...dropdownBase, width: 320 }}>
            ...
            {/* Footer */}
            <div style={{ padding: '10px 16px', textAlign: 'center', borderTop: `1px solid ${dark ? '#1f2e40' : '#F3F4F6'}` }}>
              <button
                onClick={() => { setNotifOpen(false); onNavigate('notifications'); }}
                style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: 12.5, color: '#2B6CB0', fontWeight: 600 }}
              >
        ...
        {profileOpen && (
          <div style={{ ...dropdownBase, width: 264 }}>
            ...
            <div style={{ padding: '6px 0' }}>
              <div
                style={menuItem()}
                onClick={() => { onNavigate('researchers'); setProfileOpen(false); }}
